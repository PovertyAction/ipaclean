...
using the {cmd:force} option with Stata's native {help:append} command. When {cmd:safely()} 
...
{phang}
{opt outfile} must be used with the appendreport or safely option. Saves an excel workbook of the append 
